...
const HistoricalDataPage: React.FC = () => {
  ...
  const handleDownloadCSV = () => {
    ...
    // Create CSV content
    const headers = ['Timestamp', 'Sensor Data', 'Deep Analysis', 'Control Panel'];
    const csvContent = [
      headers.join(','),
      ...data.map(row => [
        row.timestamp,
    ...
    link.setAttribute('download', `historical_data_${startDate}_to_${endDate}.csv`);
            ...
            <tbody>
              <tr className="bg-white">
                <td className="p-4 border rounded-lg shadow">
                  <h3 className="text-lg font-semibold mb-4 text-black">Sensor Data</h3>
                  <div className="h-64 bg-gray-100 rounded">
                    {/* Add chart component here */}
                  </div>
                </td>
                <td className="p-4 border rounded-lg shadow">
                  <h3 className="text-lg font-semibold mb-4 text-black">Deep Analysis</h3>
                  <div className="h-64 bg-gray-100 rounded">
                    {/* Add chart component here */}
                  </div>
                </td>
                <td className="p-4 border rounded-lg shadow">
                  <h3 className="text-lg font-semibold mb-4 text-black">Control Panel</h3>
                  <div className="h-64 bg-gray-100 rounded">
                    {/* Add chart component here */}
                  </div>
                </td>
